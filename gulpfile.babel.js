...
import dependencyLint from 'gulp-ng-dependency-lint';
...
gulp.task('scripts', () =>
    gulp.src([
      ...
      // .pipe(dependencyLint({removeDependency: true}))
      .pipe($.uglify({preserveComments: 'no', mangle: false}))
      // Output files
...
gulp.task('default', ['clean'], cb =>
  runSequence(
    'styles',
    ['lint', 'html', 'scripts', 'images', 'copy', 'json'],
